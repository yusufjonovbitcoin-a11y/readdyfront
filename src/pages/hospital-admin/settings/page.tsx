...
export default function HASettingsPage() {
  return (
    <HALayout title="Sozlamalar">
      <HASettingsPageContent />
    </HALayout>
  );
}

function HASettingsPageContent() {
  ...
  const tabs: { key: SettingsTab; label: string; icon: string }[] = [
    ...
    { key: 'language', label: 'Til va ko\'rinish', icon: 'ri-global-line' },
  ...
  return (
      <div className="max-w-3xl space-y-5">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input type="text" className={inputClass} value={profile.hospital} disabled />
                </div>
              </div>
              <div>
              ...
              <div>
                ...
                <input type="tel" className={inputClass} value={profile.phone} onChange={e => setProfile({...profile, phone: e.target.value})} />
              </div>
          ...
          <div className={cardBase}>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input type="password" className={inputClass} placeholder="••••••••" value={passwords.newPass} onChange={e => setPasswords({...passwords, newPass: e.target.value})} />
              </div>
              <div>
                <label className={labelClass}>Yangi parolni tasdiqlang</label>
                <input type="password" className={inputClass} placeholder="••••••••" value={passwords.confirm} onChange={e => setPasswords({...passwords, confirm: e.target.value})} />
              </div>
              ...
              >
                {saved ? 'Saqlandi!' : 'Parolni yangilash'}
              </button>
            </div>
        ...
        {activeTab === 'language' && (
          <div className={cardBase}>
            <h3 className={`text-sm font-bold mb-5 ${darkMode ? "text-white" : "text-gray-900"}`}>Til va ko'rinish</h3>
